 ...
 * Scans dependencies for hooks with sails.hasModels or sails.hasPolicies in their package.json.
 */
...
async function generateAllShims(appPath, options = {}) {
    ...
    try {
        ...
        const { hookModels, hookPolicies } = await findAndRegisterHooks(appPath);
        ...
        const [modelStats, policyStats, middlewareStats, responseStats, configStats] = await Promise.all([
        ...
        return {
            skipped: false,
            reason,
            stats: { modelStats, policyStats, middlewareStats, responseStats, configStats },
