 ...
 * from classes exported by @researchdatabox/redbox-core and external hooks.
 *
...
`;
      promises.push(
        writeFileIfChanged(filePath, content).then(w => {
          if (w) {
            generated++;
            fromHooks++;
          }
...
/**
 * Generates individual config shim files that export config from redbox-core.
