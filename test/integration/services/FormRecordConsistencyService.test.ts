...
import { FormModel } from '@researchdatabox/redbox-core';
        ...
        args: {
          ...
          original: {
            ...
            metadata: {
              ...
              repeatable_1: ['hello world from repeating groups'],
            },
          },
          changed: {
            redboxOid: 'abcd',
            metadata: {
              ...
              repeatable_1: ['repeatable_1 text_rpt_1 index 0 new value', 'hello world from repeating groups'],
            },
          },
        },
        expected: {
      ...
      const expected = {
        group_1: {
          ...
          group_2: {
            ...
            repeatable_2: ['text_rpt_2 default 1', 'text_rpt_2 default 2'],
          },
        },
  ...
  describe('validateRecordValues methods', async function () {
    it('passes when the record values are valid', async function () {
      const formConfig: FormModel & FormConfigFrame = {
        ...
        validators: [{ class: 'different-values', config: { controlNames: ['text_1', 'text_2'] } }],
        componentDefinitions: [
          {
            name: 'text_1',
            model: {
          ...
          },
          {
            ...
            model: {
              ...
              config: {
                defaultValue: '',
                validators: [{ class: 'required' }, { class: 'requiredTrue' }],
              },
            },
            component: { class: 'SimpleInputComponent' },
          },
                      ...
                      config: {
                        elementTemplate: {
                          ...
                          model: {
                            class: 'GroupModel',
                            config: {
                              newEntryValue: { repeatable_4: ['repeatable_4 default 1', 'repeatable_4 default 2'] },
                            },
                          },
                          component: {
                            class: 'GroupComponent',
      ...
      const record: BasicRedboxRecord = {
        ...
        metadata: {
          ...
          group_2: {
            text_4: 10,
            text_3: 'some text',
            repeatable_2: ['example@example.com'],
          },
        },
      };
      const expected = [];
    ...
    it('fails when the record values are not valid', async function () {
                ...
                componentDefinitions: [
                  ...
                  },
                  {
                    ...
                    model: {
                      ...
                      config: {
                        defaultValue: [
                          { repeatable_2_item1: 'text_rpt_2 default 1' },
                          { repeatable_2_item2: 'text_rpt_2 default 2' },
                        ],
                      },
                    },
                    component: {
      ...
      const expected: FormValidatorSummaryErrors[] = [
        ...
        },
        {
          ...
          message: null,
          lineagePaths: {
            formConfig: ['componentDefinitions', '2', 'component', 'config', 'componentDefinitions', '1'],
        ...
        },
        {
          ...
          message: null,
          lineagePaths: {
            formConfig: ['componentDefinitions', '2', 'component', 'config', 'componentDefinitions', '2'],
