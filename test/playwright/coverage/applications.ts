...
export const applicationManifest: readonly ApplicationManifestEntry[] = [
  ...
  app('A10', '@researchdatabox/dashboard-config-editor', '/default/rdmp/admin/dashboard-config', ['dashboard-config-editor input[aria-label="Filter dashboards"]', 'dashboard-config-editor .dc-nav-item'], 'configuration-editors.spec.ts'),
