  ...
  export class AppConfigs extends services.Core.Service {
    ...
    private async bootstrapAsync() {
      ...
      for (let availableBranding of availableBrandings) {
        let branding:Branding = BrandingService.getBrand(availableBranding);
    ...
    private async refreshBrandingAppConfigMap(branding: Branding) {
    ...
    public async createOrUpdateConfig(branding: Branding, configKey: string, configData: string): Promise<any> {
    ...
    public async createConfig(brandName: string, configKey: string, configData: string): Promise<any> {
      let branding:Branding = BrandingService.getBrand(brandName);
      let dbConfig = await AppConfig.findOne({ branding: branding.id, configKey });
    ...
    public async getAppConfigForm(branding: Branding, configForm: string): Promise<any> {
