...
export class ConfigModels {
    private static modelsMap: Map<string, any> = new Map([
        ...
        ['menu', {
            ...
            tsGlob: 'internal/sails-ts/api/configmodels/MenuConfig.ts'
        }],
        ['homePanels', {
            ...
            tsGlob: 'internal/sails-ts/api/configmodels/HomePanelConfig.ts'
        }],
        ['adminSidebar', {
            ...
            tsGlob: 'internal/sails-ts/api/configmodels/AdminSidebarConfig.ts'
        }],
    ]);
