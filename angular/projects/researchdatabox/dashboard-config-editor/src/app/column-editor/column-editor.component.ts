...
@Component({
  ...
  template: `
    <div class="dc-column-editor">
          ...
          @for (col of columns; track col; let i = $index) {
            ...
            >
              ...
              <span class="dc-column-flags">
                @if (col.defaultSort) {
                  <span class="dc-column-flag" title="Default sort">
                    <i class="fa fa-star"></i>
                  </span>
                }
                @if (col.initialSort) {
                  <span class="dc-column-flag" [title]="'Initial sort: ' + col.initialSort">
                    <i
                      class="fa"
                      [class.fa-sort-amount-asc]="col.initialSort === 'asc'"
                      [class.fa-sort-amount-desc]="col.initialSort === 'desc'"
                    ></i>
                  </span>
                }
              </span>
      ...
      @if (selectedColumn) {
        <div class="dc-column-detail-wrap">
