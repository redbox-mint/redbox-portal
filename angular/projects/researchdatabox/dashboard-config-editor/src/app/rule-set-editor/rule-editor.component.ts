    ...
    <div class="dc-rule-card">
      <header class="dc-rule-card-header">
        <div class="dc-rule-card-title">
          ...
          <span
            class="dc-rule-action"
            [class.dc-rule-action-show]="rule.action === 'show'"
            [class.dc-rule-action-hide]="rule.action === 'hide'"
          >
      ...
      <div class="dc-rule-card-body">
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            rows="3"
            [(ngModel)]="rule.renderItemTemplate"
            placeholder="Handlebars template returning the row markup"
          ></textarea>
        </div>
        <div class="form-group">
          ...
          <textarea
            class="form-control dc-mono"
            rows="3"
            [(ngModel)]="rule.evaluateRulesTemplate"
            placeholder="Optional expression evaluated per row"
          ></textarea>
        </div>
      </div>
    </div>
