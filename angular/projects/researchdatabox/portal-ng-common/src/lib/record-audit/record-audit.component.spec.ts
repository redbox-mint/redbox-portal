...
import { getStubTranslationService } from '../helper.spec';
...
describe('RecordAuditComponent', () => {
  ...
  async function createComponent(attributes: Record<string, string> = {}) {
    ...
    component.oid.set(fixture.nativeElement.getAttribute('oid') || '');
    component.branding.set(fixture.nativeElement.getAttribute('branding') || '');
    component.portal.set(fixture.nativeElement.getAttribute('portal') || '');
    component.isAdmin.set(fixture.nativeElement.getAttribute('is-admin') === 'true');
