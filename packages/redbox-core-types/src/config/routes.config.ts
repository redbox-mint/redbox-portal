...
export const routes: RoutesConfig = {
    ...
    '/:branding/:portal/record/:oid/attach': { controller: 'RecordController', action: 'doAttachment', csrf: false },
    '/:branding/:portal/record/:oid/attach/:attachId': { controller: 'RecordController', action: 'doAttachment', csrf: false },
