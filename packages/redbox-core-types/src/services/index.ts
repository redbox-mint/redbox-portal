...
export const ServiceExports = {
  get AgendaQueueService() { return getOrCreateService('AgendaQueueService', () => new AgendaQueueServiceModule.Services.AgendaQueue().exports()); },
  get AppConfigService() { return getOrCreateService('AppConfigService', () => new AppConfigServiceModule.Services.AppConfigs().exports()); },
  get AsynchsService() { return getOrCreateService('AsynchsService', () => new AsynchsServiceModule.Services.Asynchs().exports()); },
  get BrandingLogoService() { return getOrCreateService('BrandingLogoService', () => new BrandingLogoServiceModule.Services.BrandingLogo().exports()); },
  get BrandingService() { return getOrCreateService('BrandingService', () => new BrandingServiceModule.Services.Branding().exports()); },
  get CacheService() { return getOrCreateService('CacheService', () => new CacheServiceModule.Services.Cache().exports()); },
  get ConfigService() { return getOrCreateService('ConfigService', () => new ConfigServiceModule.Services.Config().exports()); },
  get ContrastService() { return getOrCreateService('ContrastService', () => new ContrastServiceModule.Services.Contrast().exports()); },
  get DashboardTypesService() { return getOrCreateService('DashboardTypesService', () => new DashboardTypesServiceModule.Services.DashboardTypes().exports()); },
  get DoiService() { return getOrCreateService('DoiService', () => new DoiServiceModule.Services.Doi().exports()); },
  get EmailService() { return getOrCreateService('EmailService', () => new EmailServiceModule.Services.Email().exports()); },
  get FigshareService() { return getOrCreateService('FigshareService', () => new FigshareServiceModule.Services.FigshareService().exports()); },
  get FormRecordConsistencyService() { return getOrCreateService('FormRecordConsistencyService', () => new FormRecordConsistencyServiceModule.Services.FormRecordConsistency().exports()); },
  get FormsService() { return getOrCreateService('FormsService', () => new FormsServiceModule.Services.Forms().exports()); },
  get I18nEntriesService() { return getOrCreateService('I18nEntriesService', () => new I18nEntriesServiceModule.Services.I18nEntries().exports()); },
  get NamedQueryService() { return getOrCreateService('NamedQueryService', () => new NamedQueryServiceModule.Services.NamedQueryService().exports()); },
  get NavigationService() { return getOrCreateService('NavigationService', () => new NavigationServiceModule.Services.Navigation().exports()); },
  get OniService() { return getOrCreateService('OniService', () => new OniServiceModule.Services.OniService().exports()); },
  get OrcidService() { return getOrCreateService('OrcidService', () => new OrcidServiceModule.Services.Orcids().exports()); },
  get PathRulesService() { return getOrCreateService('PathRulesService', () => new PathRulesServiceModule.Services.PathRules().exports()); },
  get RaidService() { return getOrCreateService('RaidService', () => new RaidServiceModule.Services.Raid().exports()); },
  get RDMPService() { return getOrCreateService('RDMPService', () => new RDMPServiceModule.Services.RDMPS().exports()); },
  get RecordsService() { return getOrCreateService('RecordsService', () => new RecordsServiceModule.Services.Records().exports()); },
  get RecordTypesService() { return getOrCreateService('RecordTypesService', () => new RecordTypesServiceModule.Services.RecordTypes().exports()); },
  get ReportsService() { return getOrCreateService('ReportsService', () => new ReportsServiceModule.Services.Reports().exports()); },
  ...
  get VocabularyService() { return getOrCreateService('VocabularyService', () => new VocabularyServiceModule.Services.VocabularyService().exports()); },
  ...
  get WorkspaceTypesService() { return getOrCreateService('WorkspaceTypesService', () => new WorkspaceTypesServiceModule.Services.WorkspaceTypes().exports()); },
};
