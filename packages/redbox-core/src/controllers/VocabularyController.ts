  ...
  export class Vocabulary extends controllers.Core.Controller {
    ...
    public async list(req: Sails.Req, res: Sails.Res) {
      try {
        ...
        return this.sendResp(req, res, { status: 500, errors: [error], headers: this.getNoCacheHeaders() });
      }
    }
    ...
    public async import(req: Sails.Req, res: Sails.Res) {
      try {
        ...
        return this.sendResp(req, res, { status: 400, errors: [error], headers: this.getNoCacheHeaders() });
      }
    }
