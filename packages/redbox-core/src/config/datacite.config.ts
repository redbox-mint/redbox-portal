/**
 * Datacite Config Interface and Default Values
 * Auto-generated from config/datacite.js
 */

export interface DataciteDateMapping {
    dateType: 'Available' | 'Created' | 'Updated' | 'Other';
    template: string;
    dateInformation?: string;
}

export interface DataciteRightsMapping {
    key: string;
    template: string;
}

export interface DataciteDescriptionMapping {
...
export interface DataciteMappings {
    url: string;
    ...
    identifiers: string;
    subjects: string[];
    dates: DataciteDateMapping[];
    rightsList: DataciteRightsMapping[];
    descriptions: DataciteDescriptionMapping[];
