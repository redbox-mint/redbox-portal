...
export const routes: RoutesConfig = {
  ...
  'get /:branding/:portal/dynamicAsset/formCompiledItems/:recordType/:oid?':
    'DynamicAssetController.getFormCompiledItems',
  'get /:branding/:portal/dynamicAsset/adminReportTemplates/:reportName':
    'DynamicAssetController.getAdminReportTemplates',
  'get /:branding/:portal/dynamicAsset/recordDashboardTemplates/:recordType/:workflowStage':
    'DynamicAssetController.getRecordDashboardTemplates',
  'get /:branding/:portal/dynamicAsset/dashboardViewTemplates/:dashboardView/:stepName':
    'DynamicAssetController.getDashboardViewTemplates',
  ...
  'get /:branding/:portal/record/delete/:oid': 'RecordController.getDeletedRecord',
