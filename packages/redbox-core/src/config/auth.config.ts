...
export const auth: AuthBootstrapConfig = {
    ...
    rules: [
        ...
        { path: '/:branding/:portal/admin/api-docs', role: 'Admin', can_read: true },
        { path: '/:branding/:portal/admin/api-docs(/*)', role: 'Admin', can_read: true },
        { path: '/:branding/:portal/admin/harvest-runs', role: 'Admin', can_read: true },
        ...
        { path: '/:branding/:portal/admin/report-config(/*)', role: 'Admin', can_update: true },
        ...
        { path: '/:branding/:portal/admin/integrations/figshare(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/admin/dashboard-config(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/admin/named-query(/*)', role: 'Admin', can_update: true },
        ...
        { path: '/:branding/:portal/generation(/*)', role: 'Researcher', can_update: true },
        { path: '/:branding/:portal/generation(/*)', role: 'Librarians', can_update: true },
        { path: '/:branding/:portal/generation(/*)', role: 'Admin', can_update: true },
        ...
        { path: '/:branding/:portal/service/vocab(/*)', role: 'Researcher', can_read: true },
        { path: '/:branding/:portal/service/vocab(/*)', role: 'Librarians', can_read: true },
        { path: '/:branding/:portal/service/vocab(/*)', role: 'Admin', can_read: true },
        ...
        { path: '/:branding/:portal/api/report-config(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/api/harvest-runs', role: 'Admin', can_read: true },
        { path: '/:branding/:portal/api/harvest-runs(/*)', role: 'Admin', can_read: true },
        ...
        { path: '/:branding/:portal/api/figshare-vocabularies(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/api/figshare-crosswalks(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/api/dashboard-config(/*)', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/api/named-query(/*)', role: 'Admin', can_update: true },
        ...
        { path: '/:branding/:portal/listRecords', role: 'Librarians', can_read: true },
        { path: '/:branding/:portal/listRecords', role: 'Admin', can_read: true },
        { path: '/:branding/:portal/user/genKey', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/user/revokeKey', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/user/update', role: 'Admin', can_update: true },
        { path: '/:branding/:portal/action/:action', role: 'Researcher', can_update: true },
        { path: '/:branding/:portal/action/:action', role: 'Librarians', can_update: true },
        { path: '/:branding/:portal/action/:action', role: 'Admin', can_update: true },
    ],
