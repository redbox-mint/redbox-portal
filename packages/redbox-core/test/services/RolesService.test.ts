...
describe('RolesService', function () {
  ...
  describe('getNestedRoles deprecation', function () {
    it('is no longer exported to hooks or controllers', function () {
      const exported = RolesService.exports();
      expect(exported).to.not.have.property('getNestedRoles');
    });
  });
  ...
  describe('exports', function () {
    it('should export all public methods', function () {
      ...
      expect(exported).to.not.have.property('getNestedRoles');
      expect(exported).to.not.have.property('createRoleWithBrand');
    });
  });
});
