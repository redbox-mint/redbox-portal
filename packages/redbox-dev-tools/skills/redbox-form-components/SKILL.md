...
- `redbox-dev-tools generate form-component <name> --app form`
- Optional companion service scaffold:
- `redbox-dev-tools generate form-component <name> --app form --with-service`
...
If the component uses `inlineVocab`, update `packages/redbox-core/src/visitor/vocab-inline.visitor.ts` to resolve vocab data into the component config shape.
...
If new backend endpoints are needed, update `redbox-core` controller/service/routes and add tests there.
