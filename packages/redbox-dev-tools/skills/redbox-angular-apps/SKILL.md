---
name: "Redbox Angular Apps"
description: "ReDBox uses embedded Angular applications within EJS views instead of a single SPA. Each feature is often its own Angular project."
---
