---
name: "Redbox Testing"
description: "ReDBox uses Mocha for integration testing and Bruno for API testing. All integration tests are run within Docker containers managed by docker-compose profiles."
---
...
- **Run selected Mocha tests (Development):**
  ```bash
  RBPORTAL_MOCHA_TESTS="test/unit/services/SolrSearchService.test.js" npm run test:mocha:mount
  ```
  Provide space-separated test file paths or glob patterns. The bootstrap test is always included.
