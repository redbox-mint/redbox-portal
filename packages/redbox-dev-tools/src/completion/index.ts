...
function generateZshCompletion(): string {
  ...
  return `#compdef redbox-dev-tools
...
function generateFishCompletion(): string {
  const spec = getCompletionSpec();
  const lines: string[] = [
    '# fish completion for redbox-dev-tools',
    'set -l __rbhk_cmd redbox-dev-tools',
...
function generatePowerShellCompletion(): string {
  return `# PowerShell completion for redbox-dev-tools
Register-ArgumentCompleter -Native -CommandName redbox-dev-tools -ScriptBlock {
