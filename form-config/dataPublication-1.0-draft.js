...
var footer = require('../form-config/publication/footer-draft-1.0.js');
...
mainTab[0].definition.fields = _.concat(startTab, coverageTab, dataTab, supplementsTab, licenseTab, citationTab, submitTab,  permissionsTab);
