...
|---|---|---|
| `redbox-core-types` | `@researchdatabox/redbox-core-types` | Shared TypeScript type definitions, core business logic, Waterline models, policies, config defaults, and bootstrap functions. See [Redbox Core Types](Redbox-Core-Types). |
