...
- **[Authorization Contract API](https://github.com/redbox-mint/redbox-portal/wiki/Authorization-Contract-API)**: Runtime-validated effective-principal, scope-catalog, template-read, and template-publication routes, including pagination and Problem Details.
