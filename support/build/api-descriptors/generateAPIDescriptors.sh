...
node ../render-ejs-template.js ../../../views/default/default/apidocsapib.ejs '{"portal":"rdmp","branding":"default", "baseUrl": "https://demo.redboxresearchdata.com.au"}' > apidocs.apib 
