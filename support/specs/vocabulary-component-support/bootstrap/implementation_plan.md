...
#### [MODIFY] [VocabularyService.ts](packages/redbox-core/src/services/VocabularyService.ts)
...
#### [MODIFY] [bootstrap.ts](packages/redbox-core/src/bootstrap.ts)
...
#### [MODIFY] [VocabularyService.test.ts](packages/redbox-core/test/services/VocabularyService.test.ts)
