...
- [ ] Verify generator path: `redbox-dev-tools generate form-component typeahead-input --app form`.
...
- [ ] Unit test task: update `packages/redbox-core/test/controllers/FormVocabularyController.test.ts` only when backend behavior changes.
