...
- **New/changed models and attributes**:
  - **`Vocabulary`** (`packages/redbox-core/src/waterline-models/Vocabulary.ts`):
  ...
  - **`VocabularyEntry`** (`packages/redbox-core/src/waterline-models/VocabularyEntry.ts`):
...
- **File locations**: `packages/redbox-core/src/waterline-models/`
...
- **File locations**:
  ...
  - `packages/redbox-core/src/services/RvaImportService.ts`
...
- **Response examples**:
  ...
  - Validation error (example)
    ...
    ```
- **File locations**: `packages/redbox-core/src/controllers/webservice/VocabularyController.ts`
...
- **File locations**:
  - `packages/redbox-core/src/controllers/VocabularyController.ts`
...
- **File locations**: `packages/redbox-core/src/config/brandingConfigurationDefaults.config.ts`.
