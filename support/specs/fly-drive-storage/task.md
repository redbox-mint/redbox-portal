...
- [ ] Update `packages/redbox-core/src/config/storage.config.ts` to add disk map, stagingDisk, primaryDisk, and driver config types. Skill: Redbox Services. <!-- id: 2 -->
- [ ] Add unit tests for storage config validation in `packages/redbox-core/test/services/StorageManagerService.test.ts`. Skill: Redbox Testing. <!-- id: 3 -->

- [ ] Add Flydrive v2 dependencies in `packages/redbox-core/package.json` (filesystem + s3 drivers). Skill: Redbox Services. <!-- id: 4 -->
- [ ] Add unit tests for driver registration failures and missing drivers in `packages/redbox-core/test/services/StorageManagerService.test.ts`. Skill: Redbox Testing. <!-- id: 5 -->

- [ ] Implement `packages/redbox-core/src/services/StorageManagerService.ts` with driver registration, disk accessors, and config validation. Skill: Redbox Services. <!-- id: 6 -->
- [ ] Add unit tests for `disk()`, `stagingDisk()`, `primaryDisk()` accessors. Skill: Redbox Testing. <!-- id: 7 -->

- [ ] Implement `packages/redbox-core/src/services/StandardDatastreamService.ts` implementing the full `DatastreamService` contract. Skill: Redbox Services. <!-- id: 8 -->
...
- [ ] Export new services in `packages/redbox-core/src/services/index.ts` and `packages/redbox-core/src/index.ts`. Skill: Redbox Services. <!-- id: 12 -->
